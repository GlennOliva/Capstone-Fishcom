    ...
    <a href="#" className="see-all">See All Notifications</a>
      ...
      {settingsMenuOpen && (
        <div className="setting-menu setting-menu-height">
          <div id="dark-btn" onClick={handleDarkThemeToggle}>
            <span></span>
          </div>
          <div className="setting-menu-inner">
            ...
            <div className="settings-links">
              ...
              <a href="#">settings & Privacy <img src={arrow} alt="Arrow" width="10px" /></a>
            </div>
            <div className="settings-links">
              <img src={help} alt="Help" className="settings-icon" />
              <a href="#">Help & Support <img src={arrow} alt="Arrow" width="10px" /></a>
            </div>
            <div className="settings-links">
              <img src={display} alt="Display" className="settings-icon" />
              <a href="#">Display & Accessibility <img src={arrow} alt="Arrow" width="10px" /></a>
            </div>
            <div className="settings-links">
              <img src={logout} alt="Logout" className="settings-icon" />
              <a href="#">Logout <img src={arrow} alt="Arrow" width="10px" /></a>
            </div>
          </div>
        </div>
      )}
